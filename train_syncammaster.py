...
import pandas as pd
from diffsynth import WanVideoSynCamMasterPipeline, ModelManager, load_state_dict
...
class LightningModelForDataProcess(pl.LightningModule):
    def __init__(self, text_encoder_path, vae_path, image_encoder_path=None, tiled=False, tile_size=(34, 34), tile_stride=(18, 16)):
        ...
        self.pipe = WanVideoSynCamMasterPipeline.from_model_manager(model_manager)
    ...
    def __getitem__(self, index):
        ...
        while True:
            try:
                ...
                data['view1_path'] = view1_path
                data['view2_path'] = view2_path
                break
...
class LightningModelForTrain(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        latents = rearrange(latents, 'b v ... -> (b v) ...')
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train SynCamMaster")
    parser.add_argument(
        "--task",
        type=str,
